...
export class TypescriptYeomanPipeline extends AbstractYeomanPipeline {
    pipelineArguments: TypescriptYeomanPipelineArguments;
    constructor(args: string | string[], options: {}) {
        super(args, options);
        this.pipelineArguments = new TypescriptYeomanPipelineArguments(this);
    }
